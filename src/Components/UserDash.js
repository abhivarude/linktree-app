...
export default function UserDash(props) {
  ...
  useEffect(async() =>{
    ...
    let url="https://linktree-backend-main.herokuapp.com/tree?userName="+props.match.params.name;
    let config={
      headers:{
  ...
  async function updateTree(){
    let url="https://linktree-backend-main.herokuapp.com/update-tree?userName="+props.match.params.name;
    let config={
      headers:{
        Authorisation:localStorage.getItem("Authorisation")
      }
