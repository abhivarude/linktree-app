    ...
    return (
      <div>
        ...
        <Navbar  light expand="md" style={{backgroundColor:"white"}}>
          ...
          <Collapse isOpen={isOpen} navbar>
            ...
            <div className="mr-5">
            <NavbarText className="mr-3"><a href="/login" className="btn btn-outline-primary">Login</a></NavbarText>
            <NavbarText><a href="/signup" className="btn btn-outline-primary">Signup</a></NavbarText>
            </div>
          </Collapse>
        </Navbar>
      :
      ...
      <Collapse isOpen={isOpen} navbar>
        ...
        <UncontrolledDropdown nav inNavbar>
              ...
              <DropdownMenu right>
                <DropdownItem>
                <Link to={"/profile/"+localStorage.getItem('userName')} className="btn btn-primary"> Profile</Link>
                </DropdownItem>
                <DropdownItem>
                <Link to={"/dashboard/"+localStorage.getItem('userName')} className="btn btn-primary">Tree</Link>
                </DropdownItem>
