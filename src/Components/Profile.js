...
export default function Profile(){ 
    ...
    const save= async(e)=>{
       ...
       let url= "https://linktree-backend-main.herokuapp.com/update-uInfo?userName="+context.uName;
    ...
    const deletePass = async(e)=>{
        ...
        if(k== true){               
        let url="https://linktree-backend-main.herokuapp.com/delete-account?userName="+ localStorage.getItem("userName");   
        let config={
            headers: {
                Authorisation:localStorage.getItem("Authorisation")
              }
